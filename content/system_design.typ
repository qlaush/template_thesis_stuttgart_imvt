...
= System Design
#TODO[
  This chapter follows the System Design Document Template in @breitkopf. You describe in this chapter how you map the concepts of the application domain to the solution domain. Some sections are optional, if they do not apply to your problem. Cite @breitkopf several times in this chapter.
]
